 ...
 * Description: Instructor availability delete handler. Removes an unbooked availability slot
...
$delete_statement = $dbh->prepare("DELETE FROM availability WHERE id = ? AND instructor_id = ?");
