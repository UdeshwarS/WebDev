 ...
 * Description: Student dashboard page. Displays the logged-in student's upcoming bookings,
 * total hours driven, booking status, and request cancellation actions.
 */
...
<body>
    ...
    <section class="dashboard student-dashboard-layout">
        ...
        <div class="dashboard-card hours-card">
            ...
            <p class="hours-subtitle">Based on all non-cancelled lessons</p>
        </div>
    </section>
</body>
