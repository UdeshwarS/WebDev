<?php
/*
* File: request_cancellation.php
* Description: Handles student cancellation requests. Updates a confirmed booking
* to 'cancel_requested' so the instructor can review and approve it.
